    ...
    <div className="w-full hidden xl:block xl:w-72">
      <div className="lg:sticky lg:top-16 lg:h-[calc(100vh-64px)] lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar">
        <div className="md:py-8">
          {/* Button */}
          <div className="mb-6">
            <button className="btn w-full bg-primary hover:bg-indigo-600 text-white">Create Post</button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-50 p-4 rounded border border-slate-200">
              ...
              <div className="mt-4">
                <button className="btn-sm w-full bg-white border-slate-200 hover:border-slate-300 text-primary shadow-none">Follow</button>
              </div>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded border border-slate-200">
              ...
              <div className="mt-4">
                <button className="btn-sm w-full bg-white border-slate-200 hover:border-slate-300 text-primary shadow-none">View All</button>
              </div>
            </div>
          </div>
        </div>
