...
function DirectMessages({
  ...
  return (
    <div className="mt-4">
      ...
      <ul className="mb-6">
        <li className="-mx-2">
          <button className="flex items-center justify-between w-full p-2 rounded bg-secondary" onClick={() => setMsgSidebarOpen(false)}>
            ...
            <div className="flex items-center ml-2">
              <div className="text-xs inline-flex font-medium bg-primary text-white rounded-full text-center leading-5 px-2">2</div>
            </div>
          </button>
        </li>
        <li className="-mx-2">
          <button className="flex items-center justify-between w-full p-2 rounded" onClick={() => setMsgSidebarOpen(false)}>
            ...
            <div className="flex items-center ml-2">
              <div className="text-xs inline-flex font-medium bg-primary text-white rounded-full text-center leading-5 px-2">4</div>
            </div>
          </button>
        </li>
        <li className="-mx-2">
